  ...
  const benefits = [
    {
      ...
      description: "Financial security for your family in case of unfortunate events"
    },
    {
      icon: DollarSign,
      title: "Tax Benefits",
      description: "Tax benefits under Section 80C and 10(10D) of Income Tax Act"
    },
    {
      icon: TrendingUp,
      title: "Investment Component",
      description: "Some policies offer savings and investment components"
    },
    {
      icon: Umbrella,
      title: "Optional Riders",
      description: "Optional riders for critical illness, accidental death, and disability"
    }
  ];
  ...
  const lifeInsuranceTypes = [
    {
      ...
      description: "Pure protection with high coverage at low premiums",
      icon: Shield,
      color: "bg-blue-100 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400",
      features: ["Affordable premiums", "High coverage amount", "Fixed term period"]
    },
    {
      ...
      features: ["Lifetime coverage", "Cash value builds", "Loan facility"]
    },
    {
      title: "Endowment Plans",
      description: "Insurance plus savings for future goals",
      icon: Award,
      color: "bg-green-100 dark:bg-green-900/20 text-green-600 dark:text-green-400",
      features: ["Maturity benefits", "Insurance coverage", "Guaranteed returns"]
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
              Choose the right type of life insurance based on your needs and financial goals.
            </p>
          </div>
        ...
        >
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Key Benefits of Life Insurance</h2>
          </div>
            ...
            {benefits.map((benefit, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="flex gap-4 p-4 bg-slate-50 dark:bg-slate-700/50 rounded-xl hover:bg-blue-50 dark:hover:bg-blue-900/10 transition-colors duration-300"
                >
          ...
          >
            <Link 
              to="/compare?type=life" 
              className="flex-1 bg-gradient-to-r from-blue-600 to-indigo-500 text-white px-8 py-3 rounded-xl font-semibold hover:from-blue-700 hover:to-indigo-600 transition-all duration-300 text-center flex items-center justify-center gap-2"
            >
              <TrendingUp size={18} />
              Compare Life Policies
            </Link>
        ...
        <motion.div
          ...
          className="mt-8 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/10 dark:to-indigo-900/10 rounded-2xl p-8 border border-blue-200 dark:border-blue-800/30"
        >
          ...
          <div className="grid md:grid-cols-3 gap-6 text-sm">
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-300">
                Starting life insurance at a young age means lower premiums and longer coverage period.
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
              ...
              <p className="text-slate-600 dark:text-slate-300">
                Calculate coverage as 10-15 times your annual income to ensure adequate protection.
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
              ...
              <p className="text-slate-600 dark:text-slate-300">
                Review your life insurance needs regularly as your life circumstances change.
              </p>
            </div>
          </div>
        </motion.div>
